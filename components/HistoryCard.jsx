        ...
        <View className="pt-4 mx-4 bg-white rounded-lg">
            <View className="flex-row pb-3 items-center mx-4 space-x-2">
                ...
                <View className="flex-1">
                    <Text className="font-medium px-1 text-black-400 text-xl" style={{ fontFamily: 'Poppins-Medium' }}>Maria Jones</Text>
                    <Text className="font-medium text-gray-500 text-l" style={{ fontFamily: 'Poppins-Light' }}> 19yo </Text>
                </View>
